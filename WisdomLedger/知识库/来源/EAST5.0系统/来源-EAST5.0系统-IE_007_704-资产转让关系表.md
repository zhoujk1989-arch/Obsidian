...
```sql
-- 完整 DDL 见 `原始材料/表结构/EAST5.0系统/IE_007_704-资产转让关系表-DDL-2026-04-28.sql`
...
- 血缘页：待补（血缘-IE_007_704-资产转让关系表-EAST5.0系统）

## Open Questions

- 当前尚未取得 `IE_007_704` 的实际装载 SQL、存储过程或接口落地脚本，字段级来源和加工状态待补。
