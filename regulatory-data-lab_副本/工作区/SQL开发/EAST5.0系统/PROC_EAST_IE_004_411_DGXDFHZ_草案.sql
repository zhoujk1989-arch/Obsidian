/*
业务目标：
- 依据原始业务需求《026_对公信贷分户账.md》生成 EAST5.0 对公信贷分户账（IE_004_411）GBase 存储过程草案。
...
报送要求：
- 除个人以外的各类机构（包括企业、机关团体、社保基金、部队、住房公积金）为开展各项信贷业务，在银行机构所开立的信贷账户信息。个体工商户、私营业主以营业执照等证件开立的对公信贷分户账计入本表，以个人名义开立的信贷分户账不计入本表。贷款核销和转让（包括资产证券化）相关内容应在本表填报；尤其核算方式变化（即科目变化），需要报送变化量。表外业务只报送委托贷款（非现金管理项下），其他不报送。对于票据贴现和买断式转贴现，可以填报为信贷分户账号=信贷借据号=票据号码；对于其他若没有对应信贷分户账号的业务，可以填报为信贷分户账号=信贷借据号=业务编号。以信贷借据号为最小粒度报送，借据结清、核销或转让的，可在报送最后状态的次月不再报送。账户状态为"销户"时，也可于次月不再报送。
...
- 上月末 = DATE_SUB(DATE_SUB(V_DATA_DATE, INTERVAL DAY(V_DATA_DATE) - 1 DAY), INTERVAL 1 MONTH) 作为代理；跨月边界（如1号）按自然月对齐处理，需现场确认是否应按月份对齐。
...
- 采集日期字段在目标表 CJRQ 和源表 T_6_27.F270069 均有，以 T_6_27.F270069 为主。
- 到期日期 DQRQ 来源为 T_6_27.F270018（协议调整后到期日期），原草案为 NULL，已修正。
- 备注 BBZ 使用 CONCAT_WS(';', ...) 拼接 T_4_3.D030014、T_6_27.F270068、T_8_1.H010030、T_6_2.F020062 四表备注。
- 贷款金额 DKJE 和贷款余额 DKYE 按分户账号聚合汇总。
- 发放日期 FFRQ 取同一分户账号下最小的贷款实际发放日期。
*/

DROP PROCEDURE IF EXISTS PROC_EAST_IE_004_411_DGXDFHZ;

CREATE PROCEDURE PROC_EAST_IE_004_411_DGXDFHZ(
...
BEGIN
    ...
    SELECT
        /* 1. 金融许可证号：T_1_1.A010003；加工规则：用【贷款协议补充信息】.【机构ID】关联【机构信息】.【机构ID】 */
        s4.A010003 AS JRXKZH,

        /* 2. 到期日期：T_6_27.F270018（协议调整后到期日期），转 YYYYMMDD */
        ...
        /* 4. 实际利率：T_8_1.H010021；加工映射：通过【贷款协议补充信息】.【借据ID】关联【贷款借据】.【借据ID】 */
        CAST(NULLIF(TRIM(s2.H010021), '') AS DECIMAL(20,6)) AS SJLL,

        /* 5. 归属分支机构：无来源，置 NULL */
        NULL AS GSFZJG,

        /* 6. 账户状态：T_4_3.D030013 码值转换 */
        ...
        /* 7. 销户日期：T_4_3.D030012，转 YYYYMMDD，空值默认 99991231 */
        ...
        /* 8. 发放日期：同一分户账号下最小 T_6_27.F270016，转 YYYYMMDD */
        ...
        /* 9. 贷款金额：按分户账号汇总 T_6_27.F270009 */
        agg.SUM_DKJE AS DKJE,

        /* 10. 信贷借据号：T_6_27.F270001 */
        agg.XDJJH AS XDJJH,

        /* 11. 账户名称：T_4_3.D030004 */
        src.D030004 AS ZHMC,

        /* 12. 银行机构名称：T_1_1.A010005 */
        s4.A010005 AS YHJGMC,

        /* 13. 涉密标志：无来源，置 NULL */
        NULL AS SENSITIVEFLAG,

        /* 14. 采集日期：T_6_27.F270069，转 YYYYMMDD */
        ...
        /* 15. 备注：T_4_3.D030014 + T_6_27.F270068 + T_8_1.H010030 + T_6_2.F020062，以";"拼接 */
        ...
        /* 16. 开户日期：T_4_3.D030011，转 YYYYMMDD，空值默认 99991231 */
        ...
        /* 17. 贷款余额：按分户账号汇总 T_8_1.H010010 */
        agg.SUM_DKYE AS DKYE,

        /* 18. 币种：T_6_27.F270006 */
        agg.F270006 AS BZ,

        /* 19. 信贷合同号：T_6_27.F270003 */
        agg.F270003 AS XDHTH,

        /* 20. 贷款分户账号：T_6_27.F270005 */
        agg.F270005 AS DKFHZH,

        /* 21. 客户统一编号：T_6_27.F270002 */
        agg.F270002 AS KHTYBH,

        /* 22. 明细科目名称：T_6_27.F270008 */
        agg.F270008 AS MXKMMC,

        /* 23. 明细科目编号：T_6_27.F270007 */
