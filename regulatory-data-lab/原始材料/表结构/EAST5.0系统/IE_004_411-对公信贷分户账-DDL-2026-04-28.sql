...
-- 拆分时间: 2026-04-28
-- 表: IE_004_411 对公信贷分户账
-- ============================================================

DROP TABLE IF EXISTS `IE_004_411`;
CREATE TABLE `IE_004_411` (
  ...
  `XDJJH`                  VARCHAR(100)     DEFAULT NULL COMMENT '信贷借据号；PK。关联数据项：对公信贷业务借据表.信贷借据号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='对公信贷分户账';
