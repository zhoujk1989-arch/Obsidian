...
-- 拆分时间: 2026-04-28
-- 表: IE_004_405 对公存款分户账
-- ============================================================

DROP TABLE IF EXISTS `IE_004_405`;
CREATE TABLE `IE_004_405` (
  ...
  `DGCKZH`                 VARCHAR(60)      DEFAULT NULL COMMENT '对公存款账号；PK。',
  ...
  `DGCKZHLX`               VARCHAR(60)      DEFAULT NULL COMMENT '对公存款账户类型',
  `BZ`                     VARCHAR(3)       DEFAULT NULL COMMENT '币种；PK',
  `CKYE`                   DECIMAL(20,2)    DEFAULT NULL COMMENT '存款余额；存款账户到采集日期为止的余额的金额。',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='对公存款分户账';
