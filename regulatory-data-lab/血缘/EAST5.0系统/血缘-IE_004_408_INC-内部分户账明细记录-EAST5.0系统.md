...
- 按 历史业务需求材料 的字段映射，将一表通来源表加工为 EAST5.0 `内部分户账明细记录`。
...
- SQL 草案：`sql/EAST5.0系统/PROC_EAST_IE_004_408_INC_NBFHZMX_草案.sql`
...
| --- | --- | --- | --- |
| [[数据表-T_7_10-内部分户账交易-一表通系统]] | [[数据表-IE_004_408_INC-内部分户账明细记录-EAST5.0系统]] | 字段映射、码值/日期转换后装载 `IE_004_408_INC` | ；SQL 草案（2026-05-05 重构） |
